...
//             log.debug('newPage:begin');
//             browser
//             log.debug(`newPage:this.browser=${this.browser.isConnected()}`);
//             log.debug(`newPage:browser=${browser.isConnected()}`);

//             const page = await browser.newPage();
//             log.debug('newPage:acquired');
